...
export function guideRows() {
  return [
    ...
    ['Opening surplus', `₹${OPENING_SURPLUS} was already in hand after Aug 2026. It is Sep-26’s opening (OPENING_SURPLUS on Configuration, shown on the Balance tab). Each later month’s report opens with the previous month’s leftover.`, 'Do not add old Nov 2020–Aug 2026 history here. Those books are closed.'],

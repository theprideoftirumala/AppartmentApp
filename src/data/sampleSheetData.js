...
export const GUIDE_ROWS = [
  ...
  ['Plain-English money words', 'Collection = money received from flats. Expenses = money spent. Available balance is the green cell on the Summary tab (₹1,712.54 on 29 Aug 2026).', 'The app does not use surplus/deficit rows or late-fee rows from Summary.'],
  ...
  ['Available balance', 'The Summary tab Available balance (₹1,712.54 on 29 Aug 2026) is the final figure from that workbook.', 'New rows you add on Maintenance and Expenses change the app total from that history.'],
  ['History loaded into the app', 'Setup copies Summary collections and Exp-Detailed lines into Maintenance and Expenses (when those tabs are empty). You can view and export them. Surplus/deficit and late-fee blocks are not copied.', 'The five old tabs stay as they are. Owner names stay only on Summary.'],
  ...
  ['Tab: Expenses', 'Payments out of the maintenance fund, including lines copied from Exp - Detailed. ID is usually EXP-HIST-… or EXP-… from the app.', 'Category should match a known category. Bill Attached is Y or N. Receipt link must be a Google Drive URL. Amount is a plain number.'],

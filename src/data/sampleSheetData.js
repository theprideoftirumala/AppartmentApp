...
export const GUIDE_ROWS = [
  ...
  ['Tab: Live Summary', 'Only on The Pride of Tirumala-LIVE. Same shape as the old Summary: flats across months, then expense labels (Cleaning, Generator, Lift, Service charges, R&M, …). Collection and expense cells are formulas from Maintenance and Expenses. Each month column must SUMIFS that month as text (Aug-26), not C$5. Cell A4 is tpt-live-v2.', 'Do not type collection or expense amounts here. Add the next month in the app. If a Sep-26 cell still points at C$5, open the app Dashboard or Settings → Refresh sheet layout.'],

...
export const GUIDE_ROWS = [
  ...
  ['Tab: Expenses', 'Payments out of the maintenance fund. History lines come from Exp - Detailed, then any Summary category (including Sundry) that is not already covered. ID is EXP-HIST-…, EXP-SUM-…, or EXP-… from the app.', 'Category should match a known category. Bill Attached is Y or N. Receipt link must be a Google Drive URL. Amount is a plain number.'],

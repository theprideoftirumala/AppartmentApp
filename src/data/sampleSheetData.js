...
export const GUIDE_ROWS = [
  ...
  ['Plain-English money words', 'Collection = money received from flats. Expenses = money spent. Net = Collection − Expenses. Surplus = leftover (positive). Deficit = shortfall (negative).', 'Opening cash from the 29 Aug 2026 handover is Configuration DEFICIT_LAST_YEAR = 612 (positive = surplus).'],
  ...
  ['Handover (29 Aug 2026)', 'This file is The Pride of Tirumala-APP. The five old tabs (Summary, Exp - Detailed, Borewell Exp, Motor repair oct, Notes) stay as history. Live Maintenance and Expenses start from Sep-26. Cash handed over: ₹612.', 'The app never overwrites those five tabs. Handover Summary is a readable copy of monthly totals. Owner names stay only in this sheet.'],
  ...
  ['Tab: Expenses', 'Every payment out of the maintenance fund from Sep-26 onward. ID is usually EXP-… from the app.', 'Category should match a known category. Bill Attached is Y or N. Receipt link must be a Google Drive URL. Amount is a plain number.'],
  ...
  ['Tab: Handover Summary', 'Monthly collection and expense totals copied from the old I&E Excel (Nov 2020–Aug 2026). No owner names.', 'Do not use this tab for new months. Record Sep-26 onward on Maintenance and Expenses.'],
  ['Tab: Payees', 'Watchman and vendor pay details. Add the UPI ID here, then use Pay in the app (GPay / PhonePe / any UPI app).', 'No UPI IDs were in the old workbook. Phones for lift, electrician, plumber, and garbage came from the Notes tab.'],
  ...
  ['If the website stops', 'This sheet still works. File → Version history can undo mistakes. Settings → Backup copies the whole file to Drive/backups.', 'To reconnect the app: run Setup again. It finds The Pride of Tirumala-APP in Drive. It will not create a second file.'],
];

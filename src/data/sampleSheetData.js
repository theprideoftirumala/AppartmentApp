...
export const GUIDE_ROWS = [
  ...
  ['Tab: Live Summary', 'Only on The Pride of Tirumala-LIVE. Same shape as the old Summary: flats across months, then expense labels (Cleaning, Generator, Lift, Service charges, R&M, …). Collection and expense cells are ARRAYFORMULA lookups from Maintenance and Expenses. They match the month as text or as a date, and the flat as text or a number. Cell A4 is tpt-live-v4.', 'Do not type collection or expense amounts here. Add the next month in the app. Open Dashboard or Settings → Refresh sheet layout if A4 is older than tpt-live-v4.'],

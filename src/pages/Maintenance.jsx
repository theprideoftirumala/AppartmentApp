...
import { Building2, Check, Clock, AlertCircle, Plus, Filter } from 'lucide-react';
import { useApp } from '../contexts/AppContext';
import { useAuth } from '../contexts/AuthContext';
import { getMaintenanceRecords, upsertMaintenancePayment, initializeMonthMaintenance, getFlats, getConfiguration } from '../services/googleSheets';
import { addAuditLog } from '../services/googleSheets';
import { formatCurrency, getCurrentMonthLabel, getFiscalMonthOptions } from '../utils/helpers';
import { PAYMENT_MODES, MAINTENANCE_STATUS } from '../config/constants';
...
export default function Maintenance() {
  ...
  const handleInitMonth = async () => {
    try {
      ...
      showToast('Failed to initialize month', 'error');
    } finally {
      setSaving(false);
    }
  };
      ...
      <form onSubmit={handleSubmit} className="form-grid">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="number" className="form-input" value={formData.amountDue} onChange={e => update('amountDue', Number(e.target.value))} />
          </div>
          <div className="form-group">
            <label className="form-label">Amount Paid (₹)</label>
            <input type="number" className="form-input" value={formData.amountPaid} onChange={e => update('amountPaid', Number(e.target.value))} required />
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input type="date" className="form-input" value={formData.paymentDate} onChange={e => update('paymentDate', e.target.value)} />
          </div>
          <div className="form-group">
        ...
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <input type="number" className="form-input" value={formData.lateFee} onChange={e => update('lateFee', Number(e.target.value))} />
          </div>
        </div>

    ...
    <div className="login-page">
      ...
      <div className="login-container animate-fade-in-up">
        ...
        <div className="login-brand">
          ...
          <p className="login-subtitle">Apartment maintenance, made calm and clear</p>
        </div>
        ...
        {/* Google Sign In */}
        <button
          className="btn btn-lg login-btn login-btn-google"
          onClick={handleSignIn}
          disabled={loading || authLoading || showGuestForm}
        >
          {loading ? (
            <><div className="loading-spinner" style={{ width: 20, height: 20 }}><svg viewBox="0 0 50 50"><circle cx="25" cy="25" r="20" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeDasharray="80, 200" /></svg></div>Signing in...</>
          ) : (

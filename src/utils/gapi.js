...
/** Recreate the request on each attempt. Pass a factory, never a used thenable. */
export function gapiRetry(factory, maxAttempts = 3) {
  return withRetry(() => Promise.resolve(factory()), maxAttempts);
}
